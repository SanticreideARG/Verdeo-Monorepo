...
CREATE INDEX "domain_events_pending_idx" ON "domain_events" USING btree ("published_at","occurred_at");--> statement-breakpoint
CREATE INDEX "domain_events_aggregate_idx" ON "domain_events" USING btree ("aggregate_type","aggregate_id");--> statement-breakpoint
CREATE INDEX "domain_events_correlation_id_idx" ON "domain_events" USING btree ("correlation_id");